...
namespace eZexcelAPI
{
    public class ExcelFunction
    {
        ...
        public static T[] ConvertRangeDataToVector<T>(Range rg)
        {
        ...
        public static T[,] ConvertRangeDataToMatrix<T>(Range rg)
        {
            ...
            //
            int intRowsCount = RangeData.GetLength(0) - 1 - LB_Range + 1;
            var a = RangeData.GetLength(2);
            int intColumnsCount = RangeData.GetLength(1) - LB_Range + 1;
            //
