...
#Region "  ---窗口的大小、位置与布局"
    ...
    <DllImport("user32.dll", SetLastError:=True)>
    Public Shared Function SetWindowPos(ByVal hWnd As IntPtr, ByVal hWndInsertAfter As IntPtr,
...
#Region "  ---  窗口间的关系"
    ...
    <DllImport("user32.dll", SetLastError:=True, CharSet:=CharSet.Auto)>
    Public Shared Function GetWindow(ByVal hWnd As IntPtr, ByVal uCmd As GetWndConsts) As IntPtr
    End Function
...
#End Region
    ...
    Public Declare Function IsWindow Lib "user32" Alias "IsWindow" (ByVal hwnd As IntPtr) As Boolean
...
#Region "  ---  操作窗口"
    ...
    <DllImport("user32.dll")>
    Private Overloads Shared Function RedrawWindow(hWnd As IntPtr, <[In]> ByRef lprcUpdate As RECT, hrgnUpdate As IntPtr, flags As RedrawWindowFlags) As Boolean
    End Function

    <DllImport("user32.dll")>
    Public Overloads Shared Function RedrawWindow(hWnd As IntPtr, lprcUpdate As IntPtr, hrgnUpdate As IntPtr, flags As RedrawWindowFlags) As Boolean
    End Function
...
#Region "  ---  窗口属性"
    ...
    Public Shared Function GetWindowThreadProcessId(ByVal handle As Integer, <Out()> ByRef processId As Integer) As Integer
        '中间没有任何执行方法
    End Function
    ...
    ''' <remarks></remarks>
    <DllImport("user32.dll", SetLastError:=True)>
    Public Shared Function GetWindowLong(hWnd As IntPtr,
