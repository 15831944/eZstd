...
namespace eZstd.UserControls
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public partial class NumberChanging : System.Windows.Forms.UserControl
    {
        ...
        public NumberChanging()
        {
            InitializeComponent();
            //
            string[] names = Enum.GetNames(typeof(TimeSpan2.TimeSpanUnit));
            cbUnit.Items.Clear();
        ...
        {
            this._unit = (TimeSpan2.TimeSpanUnit)Enum.Parse(typeof(TimeSpan2.TimeSpanUnit), cbUnit.SelectedItem.ToString(), true);
        }
        #endregion
        ...
        {
            return TimeSpan2.GetTimeFromTimeSpan(originTime, (int)ValueNumber, Unit);
        }
